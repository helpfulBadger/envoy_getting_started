...
docker logs 05_opa_validate_jws_opa_1   2> bug_report_grpc_succeeds_opa_logs.json
docker logs 05_opa_validate_jws_envoy_1 2> bug_report_grpc_succeeds_envoy_logs.txt
