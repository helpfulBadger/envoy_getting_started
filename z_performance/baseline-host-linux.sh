...
./wrk_linux -t 4 -c100 -d30s --latency http://localhost:8000/api/customer  > results/api-customer-host-baseline-wrk.txt
printf "    Finished!!!!\n"
...
read -n 1 -r -s -p $'Press enter to continue...\n'
printf "    Running load test.....\n"
./wrk_linux -t 4 -c100 -d30s --latency http://localhost:8000/api/customer  > results/api-customer-host-baseline-wrk2.txt
printf "    Finished!!!!\n"
...
read -n 1 -r -s -p $'Press enter to continue...\n'
printf "    Running load test.....\n"
./hey_linux -z 30s -c 75              'http://localhost:8000/api/customer' > results/api-customer-host-baseline-hey.txt
printf "    Finished!!!!\n"
